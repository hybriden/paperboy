...
export function DialogContent({
  ...
  return (
    <RDialog.Portal>
      ...
      <RDialog.Content
        className={`fixed left-1/2 top-1/2 z-50 max-h-[85vh] -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-lg border border-line bg-panel p-5 shadow-pop outline-hidden data-[state=open]:animate-scale-in ${sizeClass[size]} ${className}`}
      >
